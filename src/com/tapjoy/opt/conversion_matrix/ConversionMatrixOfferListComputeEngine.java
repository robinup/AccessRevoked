...
public class ConversionMatrixOfferListComputeEngine extends OfferListComputeEngine {
	...
	private String [] getConversionHistoryFromHbase (String udid) {
        ...
        Result res = HBaseConn.getOneRecordInTableWithTimeout(udid, 0 ,((ConversionMatrixResourceDataContainer)dataContainer).auxtables, Configuration.HBASE_TIMEOUT_THRES, Configuration.HBASE_TRAFFIC_TIME);  //real-time query with pre-created table object
